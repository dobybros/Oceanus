package oceanus.sdk.rpc.queue;//package com.docker.rpc.queue;
//
...
//        try {
//            producer.send(new ProducerRecord(topic, jsonObject.toString().getBytes("utf-8")), (recordMetadata, e) -> {
//                if(e != null){
//                    LoggerEx.error(TAG, "Send message to kafka error!, topic: " + topic + ", err: " + ExceptionUtils.getFullStackTrace(e));
//                }
//            });
//        }catch (UnsupportedEncodingException e){
//            LoggerEx.error(TAG, "Encoding not support, msg: " + e);
//        }
//    }
//
//    @Override
