...
public class IMBeanApp extends ContextBeanApp {
    ...
    public synchronized IMExtensionCache getIMExtensionCache() {
        if(instance.imExtensionCache == null){
            ...
            instance.imExtensionCache.setHost(baseConfiguration.getRedisHost());
        }
    ...
    public synchronized PingHandler getPingHandler() {
        if(instance.pingHandler == null){
            ...
            instance.pingHandler.setUseProxy(baseConfiguration.getUseProxy());
        }
    ...
    public synchronized NioSocketAcceptorEx getWsIoAcceptor() {
        if(instance.wsIoAcceptor == null){
            ...
            instance.wsIoAcceptor.setDefaultLocalAddress(new InetSocketAddress(Integer.valueOf(baseConfiguration.getUpstreamWsPort())));
        }
...
//            map.put("sslFilter", instance.getSslFilter());
    ...
    public synchronized NioSocketAcceptorEx getSslTcpIoAcceptor() {
        if(instance.sslTcpIoAcceptor == null){
            ...
            instance.sslTcpIoAcceptor.setDefaultLocalAddress(new InetSocketAddress(Integer.valueOf(baseConfiguration.getUpstreamSslPort())));
        }
    ...
    public synchronized SslContextFactory getSslContextFactory() {
        if(instance.sslContextFactory == null){
            ...
            try {
                ...
                instance.sslContextFactory.setKeyManagerFactoryKeyStorePassword(baseConfiguration.getKeymanagerPwd());
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public synchronized KeyStoreFactory getKeystoreFactory() {
        if(instance.keystoreFactory == null){
            ...
            instance.keystoreFactory.setPassword(baseConfiguration.getKeystorePwd());
    ...
    public synchronized NioSocketAcceptorEx getTcpIoAcceptor() {
        if(instance.tcpIoAcceptor == null){
            ...
            instance.tcpIoAcceptor.setDefaultLocalAddress(new InetSocketAddress(Integer.valueOf(baseConfiguration.getUpstreamPort())));
        }
