package com.container.im;

import chat.errors.CoreException;
import chat.logs.LoggerEx;
import com.container.annotation.ProxySessionListener;
...
public class ProxyAnnotationHandler extends ClassAnnotationGlobalHandler {
    ...
    private List<GroovyObjectEx<com.container.im.ProxySessionListener>> tcpListeners = new ArrayList<>();
    ...
    public void handleAnnotatedClassesInjectBean(AbstractRuntimeContext runtimeContext) {
        for (GroovyObjectEx<com.container.im.ProxySessionListener> groovyObjectEx : tcpListeners) {
            try {
                groovyObjectEx = (GroovyObjectEx<com.container.im.ProxySessionListener>) getObject(null, groovyObjectEx.getGroovyClass(), runtimeContext);
    ...
    public void handleAnnotatedClasses(Map<String, Class<?>> annotatedClassMap, AbstractRuntimeContext runtimeContext) throws CoreException {
        if (annotatedClassMap != null && !annotatedClassMap.isEmpty()) {
            ...
            List<GroovyObjectEx<com.container.im.ProxySessionListener>> newTcpList = new ArrayList<>();
            ...
            for (String key : keys) {
                ...
                if (groovyClass != null) {
                    ...
                    if (messageReceivedAnnotation != null) {
                        GroovyObjectEx<com.container.im.ProxySessionListener> messageReceivedObj = (GroovyObjectEx<com.container.im.ProxySessionListener>) getObject(null, groovyClass, runtimeContext);
    ...
    public List<GroovyObjectEx<com.container.im.ProxySessionListener>> getTcpListeners() {
        return tcpListeners;
    }
}
