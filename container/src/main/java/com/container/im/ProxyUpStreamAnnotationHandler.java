...
import com.container.annotation.ProxyMessageReceived;
...
public class ProxyUpStreamAnnotationHandler extends ClassAnnotationGlobalHandler {
    ...
    public void handleAnnotatedClassesInjectBean(AbstractRuntimeContext runtimeContext) {
        for (GroovyObjectEx<ProxyMessageReceivedListener> groovyObjectEx : proxyMessageReceivedListeners) {
            try {
                groovyObjectEx = (GroovyObjectEx<com.container.im.ProxyMessageReceivedListener>) getObject(null, groovyObjectEx.getGroovyClass(), runtimeContext);
            ...
            for (String key : keys) {
                ...
                if (groovyClass != null) {
                    ...
                    if (messageReceivedAnnotation != null) {
                        GroovyObjectEx<ProxyMessageReceivedListener> messageReceivedObj = (GroovyObjectEx<com.container.im.ProxyMessageReceivedListener>) getObject(null, groovyClass, runtimeContext);
