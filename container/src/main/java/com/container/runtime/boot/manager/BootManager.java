...
public class BootManager implements ShutdownListener {
    ...
    public void setServiceVersionService(ServiceVersionServiceImpl serviceVersionService) {
    ...
    public void setDeployServiceVersionService(DeployServiceVersionServiceImpl deployServiceVersionService) {
        this.deployServiceVersionService = deployServiceVersionService;
    }
}
