...
public class CleanDocumentCodec implements CollectibleCodec<com.docker.storage.mongodb.CleanDocument> {
    ...
    @Override
    public boolean documentHasId(final com.docker.storage.mongodb.CleanDocument document) {
        return document.containsKey(ID_FIELD_NAME);
    }

    @Override
    public BsonValue getDocumentId(final com.docker.storage.mongodb.CleanDocument document) {
    ...
    @Override
    public com.docker.storage.mongodb.CleanDocument generateIdIfAbsentFromDocument(final com.docker.storage.mongodb.CleanDocument document) {
        if (!documentHasId(document)) {
    ...
    @Override
    public void encode(final BsonWriter writer, final com.docker.storage.mongodb.CleanDocument document, final EncoderContext encoderContext) {
        writeMap(writer, document, encoderContext);
    }

    @Override
    public com.docker.storage.mongodb.CleanDocument decode(final BsonReader reader, final DecoderContext decoderContext) {
    	com.docker.storage.mongodb.CleanDocument document = new com.docker.storage.mongodb.CleanDocument();
    ...
    @Override
    public Class<com.docker.storage.mongodb.CleanDocument> getEncoderClass() {
