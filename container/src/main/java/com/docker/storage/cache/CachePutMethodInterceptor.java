...
public class CachePutMethodInterceptor implements MethodInterceptor {
    ...
    private com.docker.storage.cache.CacheAnnotationHandler cacheAnnotationHandler;
    ...
    public Object invoke(MethodInvocation methodInvocation) throws CoreException {
        ...
        if (cacheMethodMap != null && !cacheMethodMap.isEmpty()) {
            ...
            if (cacheObj != null) {
                ...
                CacheStorageAdapter cacheStorageAdapter = com.docker.storage.cache.CacheStorageFactory.getInstance().getCacheStorageAdapter(cacheObj.getCacheMethod(), cacheHost);
    ...
    public String getCacheHost(String cacheMethod) {
        if (StringUtils.isBlank(cacheMethod)) {
            cacheMethod = com.docker.storage.cache.CacheStorageMethod.METHOD_REDIS;
        }
