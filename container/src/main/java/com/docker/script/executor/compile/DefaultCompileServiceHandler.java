    ...
    public void compile() throws CoreException{
        ...
        try {
            ...
            if(sourceClassLoader instanceof MyGroovyClassLoader){
                parseServiceHandler = (ParseServiceHandler) Class.forName("com.docker.script.executor.compile.DefaultGroovyParseServiceHandler").getDeclaredConstructor(BaseRuntimeContext.class).newInstance((BaseRuntimeContext)runtimeContext);
            }
