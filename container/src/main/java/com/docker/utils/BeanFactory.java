...
public class BeanFactory {
    private static Map<String, String> classBeanNameMap = new ConcurrentHashMap<>();
    ...
    public static Object getBean(String classPath) throws BeansException {
        ...
        return SpringContextUtil.getBean(classBeanNameMap.get(classPath));
    }
    ...
    public static void init(BaseConfiguration o){
        classBeanNameMap = new ConcurrentHashMap<>();
        baseConfiguration = o;
    }
    ...
    public static void map() {
        ...
        for (String beanName : beanNames) {
            ...
            if(bean != null){
                classBeanNameMap.put(bean.getClass().getName(), beanName);
            }
        }
    }
