...
public class RPCClientAdapterMapFactory {
    ...
    private com.docker.rpc.RPCClientAdapterMap rpcClientAdapterMap;
    private com.docker.rpc.RPCClientAdapterMap rpcClientAdapterMapSsl;

    public com.docker.rpc.RPCClientAdapterMap getRpcClientAdapterMap() {
        if(rpcClientAdapterMap == null){
            synchronized (RPCClientAdapterMapFactory.class) {
                if(rpcClientAdapterMap == null){
                    rpcClientAdapterMap = new com.docker.rpc.RPCClientAdapterMap();
                }
            }
        }
    ...
    public com.docker.rpc.RPCClientAdapterMap getRpcClientAdapterMapSsl() {
