...
public class RMIClientHandler extends RPCClientAdapter {
    ...
    private com.docker.rpc.impl.RMIServer server;

    private boolean enableSsl = false;

    private ConcurrentHashMap<String, com.docker.rpc.impl.RPCEntity> typeEntityMap = new ConcurrentHashMap<>();
...
//    private AverageCounter averageCounter;
    ...
    private com.docker.rpc.impl.ExpireListener<RPCClientAdapter> expireListener;
            ...
            while (isStarted) {
                ...
                if (isStarted) {
                    ...
                    try {
                        ...
                        server = (com.docker.rpc.impl.RMIServer) registry.lookup(rmiId);
...
//                averageCounter.add((int) (System.currentTimeMillis() - time));
    ...
    com.docker.rpc.impl.RPCEntity getRPCEntityForClient(String requestType, RPCRequest request) throws CoreException {
        com.docker.rpc.impl.RPCEntity entity = typeEntityMap.get(requestType);
        if (entity == null) {
            ...
            if (requestClass != null && responseClass != null) {
                entity = new com.docker.rpc.impl.RPCEntity();
                entity.requestClass = request.getClass();
                entity.responseClass = responseClass;
            }
            com.docker.rpc.impl.RPCEntity previousEntity = typeEntityMap.putIfAbsent(requestType, entity);
    ...
    private RPCResponse handleResponse(String requestType, RPCRequest request, byte[] data) throws CoreException, IllegalAccessException, InstantiationException {
        com.docker.rpc.impl.RPCEntity entity = getRPCEntityForClient(requestType, request);
    ...
    com.docker.rpc.impl.RPCEntity getRPCEntityForServer(String requestType, Class<RPCServerAdapter> serverAdapterClass) throws CoreException {
        com.docker.rpc.impl.RPCEntity entity = typeEntityMap.get(requestType);
        if (entity == null) {
