...
public abstract class RPCClientAdapter {
	...
	public static abstract class ClientAdapterStatusListener {
		...
		public void called(String serverName, com.docker.rpc.RPCRequest request,
				com.docker.rpc.RPCResponse response) {
		}

		public void callFailed(String serverName, com.docker.rpc.RPCRequest request,
				CoreException e) throws CoreException {
		}
	}

	public abstract RPCResponse call(com.docker.rpc.RPCRequest request) throws CoreException;
