 ...
 */
public class RPCServerMethodInvocation extends RPCServerAdapter<com.docker.rpc.MethodRequest, com.docker.rpc.MethodResponse> {
    ...
    @Override
    public com.docker.rpc.MethodResponse onCall(com.docker.rpc.MethodRequest request) throws CoreException {
    ...
    @Override
    public Object oncallAsync(com.docker.rpc.MethodRequest request, String callbackFutureId) throws CoreException {
        ServiceSkeletonAnnotationHandler.SkelectonMethodMapping methodMapping = getMethodMapping(request);
